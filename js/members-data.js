/*
  ...
  HOW TO ADD A NEW MEMBER
    1. Put their professional (composite) photo in
       ...
       matches the existing photos). ".jpeg" works too if that's the
       extension the photo already has — just make sure the `photo`
       field below is spelled with whichever extension the actual
       file uses.
    2. (Optional) put a casual photo in assets/img/members-casual/
       the same way (.jpg or .jpeg, same rule as above). Skip this
       and leave `casualPhoto: null` and a neutral placeholder image
       is used automatically instead — never point casualPhoto at a
